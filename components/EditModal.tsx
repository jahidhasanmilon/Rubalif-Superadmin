...
export default function EditModal({ target, onClose, topics }: EditModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
      <div className="w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-xl border border-neutral-200/60 bg-white p-6 shadow-2xl shadow-black/10 dark:border-neutral-800/60 dark:bg-neutral-900 dark:shadow-black/50">
