  ...
  return (
    <div className="mesh-bg flex h-dvh w-full overflow-hidden bg-white dark:bg-neutral-950 md:gap-3 md:bg-neutral-100 md:p-3">
      <Sidebar
        ...
        onLogout={logout}
      />
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden border-neutral-200 bg-white dark:border-neutral-700 dark:bg-neutral-900 md:rounded-xl md:border md:shadow-xl md:shadow-black/5 dark:md:shadow-black/40">
        <Topbar
          activeTab={activeTab}
          isDark={isDark}
