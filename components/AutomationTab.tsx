...
export default function AutomationTab({ active, user }: AutomationTabProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-2xl border border-neutral-200/60 bg-gradient-to-br from-accent/5 via-transparent to-blue-500/5 p-5 shadow-sm dark:border-neutral-800/60 dark:bg-neutral-900 dark:shadow-black/20">
